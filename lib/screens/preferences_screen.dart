                ...
                _buildSection('Discovery Settings', [
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Don`t Show', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Colors.brown)),
                        ...
                        const Text('Sort By', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Colors.brown)),
                        const SizedBox(height: 12),
                        Wrap(
                          spacing: 10,
                          runSpacing: 10,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(icon, size: 20, color: AppColors.deepEmerald),
              const SizedBox(width: 10),
              Text(
                label,
                style: TextStyle(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(color: AppColors.midnightEmerald, fontSize: 13),
                        ),
                      ],
                    ),
                  ),
