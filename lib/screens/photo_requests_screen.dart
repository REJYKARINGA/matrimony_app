        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(title, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: AppColors.cardDark)),
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: Text(
                                name,
                                style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: AppColors.cardDark),
                              ),
                            ),
                            Container(
                  ...
                  if (request['status'] == 'pending') ...[
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: const Text('Decline', style: TextStyle(fontWeight: FontWeight.w500)),
