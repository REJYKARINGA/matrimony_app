...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  Widget _buildForm() {
    return Form(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Select ID Type', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15, color: AppColors.textDark)),
          const SizedBox(height: 12),
          Container(
          ...
          const Text('ID Number (Optional)', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15, color: AppColors.textDark)),
          const SizedBox(height: 12),
          TextFormField(
  ...
  Widget _buildImagePicker(bool isFront) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(isFront ? 'Front Side' : 'Back Side', style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 14, color: AppColors.textDark)),
