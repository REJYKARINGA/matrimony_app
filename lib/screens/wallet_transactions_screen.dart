...
class _TransferDialogState extends State<_TransferDialog> {
      ...
      children: [
        ...
        ElevatedButton(
          ...
          child: _isProcessing 
            ...
            : const Text('Request Recipient OTP', style: TextStyle(fontWeight: FontWeight.w500)),
        ),
      ],
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          autofocus: true,
          textAlign: TextAlign.center,
          style: const TextStyle(fontSize: 24, letterSpacing: 8, fontWeight: FontWeight.w500),
          decoration: InputDecoration(
            counterText: '',
            hintText: '------',
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
        ...
        ElevatedButton(
          ...
          child: _isProcessing 
            ? const SizedBox(height: 20, width: 20, child: CircularProgressIndicator(color: AppColors.cardDark, strokeWidth: 2))
            : const Text('Confirm Transfer', style: TextStyle(fontWeight: FontWeight.w500)),
        ),
        TextButton(
  ...
  Widget _billRow(String label, String value, {bool isBold = false}) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(label, style: TextStyle(color: isBold ? Colors.black : Colors.grey.shade600, fontWeight: FontWeight.w500, fontSize: 13)),
